function demo_Riemannian_SPD_GMR01
...
in=1; outMat=2:model.nbVar; out = 2:model.nbVarVec;
...
for i=1:model.nbStates
	plotGMM([model.MuMan(in,i)*sc; 0], MuManMatOut(:,:,i), clrmap(i,:), .3);
end
for t=1:nbData
	plotGMM([xIn(1,t)*sc; 0], xhatMat(:,:,t), [0 1 0], .1);
end
