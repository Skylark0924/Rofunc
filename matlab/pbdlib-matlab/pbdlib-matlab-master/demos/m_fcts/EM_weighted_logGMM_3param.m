function [model, GAMMA2, LL] = EM_weighted_logGMM_3param(Data, w, model)
...
diagRegularizationFactor = 0E-4; %Regularization term is optional
...
% 		model.Gamma(:,i) = DataTmp - 1; %To avoid the inappropriate solution of 3-param lognormal
