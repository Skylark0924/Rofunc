function demo_manipulabilityTransfer03
...
% The gradient of the cost function is approximated numerically to speed up computation time.
%
...
function M = spdMean(setS, nbIt)
	...
	% This represents the result of a Newton gradient descent algorithm for the Karcher or Frechet mean.
	if nargin == 1
		nbIt = 10;
	end
	M = setS(:,:,1);
