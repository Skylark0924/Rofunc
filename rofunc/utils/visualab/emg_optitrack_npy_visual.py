...
impedance_threshold_1 = np.where(impedance_1 > 0.3, 1, 0)
...
plt.yticks(fontproperties='Times New Roman', size=14)
plt.ylim(-0.5, 2.5)
plt.plot(t_1, impedance_1[:], color="limegreen", label='Estimated Stiffness $K_{h}$', linewidth=3)
plt.plot(t_1, impedance_threshold_1[:], color="red", label='Threshold', linewidth=2)
# plt.text(5, 2, r'End Effector_Left', fontsize=14)
plt.legend(loc="upper left", facecolor='white', edgecolor='grey', prop={'size': 18})
...
plt.savefig('/home/ubuntu/Data/20230627/1.png', dpi=600)
plt.show()
