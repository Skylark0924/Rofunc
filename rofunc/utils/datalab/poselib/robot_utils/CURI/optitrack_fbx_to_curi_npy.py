...
def motion_retargeting(retarget_cfg, source_motion, visualize=False):
    ...
    rf.logger.beauty_print(f"Saved CURI dof_states to {retarget_cfg['target_motion_path']}", type="module")
...
def npy_from_fbx(fbx_file):
    ...
    config = {
        ...
        "target_dof_states_path": fbx_file.replace('_optitrack.fbx', '_optitrack2curi_dof_states.npy'),
