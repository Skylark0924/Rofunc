...
if __name__ == '__main__':
    ...
    xml_path = os.path.join(rofunc_path, "simulator/assets/mjcf/themis/TH01.xml")
    save_path = os.path.join(rofunc_path, "utils/datalab/poselib/data/target_themis_w_qbhand_tpose.npy")
