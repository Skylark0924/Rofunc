...
if __name__ == '__main__':
    ...
    xml_path = os.path.join(rofunc_path, "simulator/assets/mjcf/zju_humanoid/zju_humanoid.xml")
    save_path = os.path.join(rofunc_path, "utils/datalab/poselib/data/target_zju_humanoid_tpose.npy")
