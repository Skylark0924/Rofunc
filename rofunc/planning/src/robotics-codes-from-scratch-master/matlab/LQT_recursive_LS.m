%% Linear quadratic tracking (LQT) applied to a viapoint task with a recursive foRaulation 
...
%% it under the teRas of the GNU General Public License version 3 as
