...
from rofunc.learning.rl.models.base_model import Model
...
class Agent:
    def __init__(self,
        ...
        # convert the pre_trained_models to their respective device
    ...
    def migrate(self,
        ...
        For ambiguous pre_trained_models (where 2 or more parameters, for source or current model, have equal shape)
    ...
    def post_interaction(self, timestep: int, timesteps: int) -> None:
        ...
        # update best pre_trained_models and write data to tensorboard
        if timestep > 1 and self.write_interval > 0 and not timestep % self.write_interval:
            # update best pre_trained_models
