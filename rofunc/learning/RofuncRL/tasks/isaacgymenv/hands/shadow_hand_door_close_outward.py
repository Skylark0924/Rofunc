...
class ShadowHandDoorCloseOutwardTask(VecTask):
    """
    ...
    def reset_idx(self, env_ids, goal_env_ids):
        ...
        self.prev_targets[env_ids, self.num_shadow_hand_dofs * 2:self.num_shadow_hand_dofs * 2 + 2] = to_torch(
            [1.57, 1.57], device=self.device)
        self.cur_targets[env_ids, self.num_shadow_hand_dofs * 2:self.num_shadow_hand_dofs * 2 + 2] = to_torch(
            [1.57, 1.57], device=self.device)
