...
class ShadowHandGraspTask(VecTask):
    """
    ...
    def __init__(self, cfg, rl_device, sim_device, graphics_device_id, headless, virtual_screen_capture,
        ...
        self.num_agents = 1
        self.cfg["env"]["numActions"] = 26  # 2-dim synergy for controlling each hand
    ...
    def _create_envs(self, num_envs, spacing, num_per_row):
        ...
        hand_asset_file = "mjcf/open_ai_assets/hand/shadow_hand.xml"
        ...
        hand_start_pose.r = gymapi.Quat().from_euler_zyx(0, 1.57, -1.57)
        ...
        max_agg_bodies = self.num_hand_bodies + 2 * self.num_object_bodies + 1
        max_agg_shapes = self.num_hand_shapes + 2 * self.num_object_shapes + 1
        ...
        self.fingertip_handles = [self.gym.find_asset_rigid_body_index(hand_asset, name) for name in
                                  self.fingertips]
        ...
        for i in range(self.num_envs):
            ...
            self.gym.set_actor_scale(env_ptr, goal_handle, 1.2)
    ...
    def compute_observations(self):
        ...
        self.hand_pos = self.rigid_body_states[:, 3, 0:3]
        self.hand_rot = self.rigid_body_states[:, 3, 3:7]
    ...
    def compute_full_state(self, asymm_obs=False):
        ...
        hand_pose_start = fingertip_obs_start + 95  # 140 = 45 + 95
...
def compute_hand_reward(
        ...
        hand_pos,
        # hand_ff_pos, hand_mf_pos, hand_rf_pos, hand_lf_pos, hand_th_pos,
    ...
    resets = torch.where(hand_dist >= 1., torch.ones_like(resets), resets)
