import numpy as np
from rofunc.utils.robolab.kinematics import fk, jacobian
...
class robot_config:
    ...
    def fkine(self, x):
        ...
        """
        robot, f, cfg = fk("/home/ubuntu/Rofunc/rofunc/simulator/assets/urdf/gluon/gluon.urdf", ["axis_joint_1", "axis_joint_2", "axis_joint_3", "axis_joint_4", "axis_joint_5", "axis_joint_6"], x, export_link='6_Link')
    ...
    def jacob(self, x):
        ...
        J = jacobian.get_jacobian_from_model("/home/ubuntu/Rofunc/rofunc/simulator/assets/urdf/gluon/gluon.urdf", ee_link_name='6_Link', joint_values=x)
    ...
    def fkinall(self, x):
        ...
        for i in range(len(link_names)):
            robot, f, cfg = fk("/home/ubuntu/Rofunc/rofunc/simulator/assets/urdf/gluon/gluon.urdf", ["axis_joint_1", "axis_joint_2", "axis_joint_3", "axis_joint_4", "axis_joint_5", "axis_joint_6"], x, link_names[i])
