...
forces[:, 25, 1] = force_intf
torques[:, 25, 1] = torque_intf
forces[:, 36, 1] = force_intf
torques[:, 36, 1] = torque_intf
# efforts[:, 9, 0] = 100000
efforts[4] = 100000
rf.curi.run_traj_multi_joints_with_interference(args, traj=[traj_l, traj_r], intf_mode="body_forces",
                                                ...
                                                intf_index=[i for i in range(50, 100)],
                                                num_envs=num_envs, update_freq=0.001)
