"""
AuboCubeOmni (RofuncRL)
===========================

AuboCube RL using RofuncRL
"""
...
def inference(custom_args):
    ...
    if custom_args.ckpt_path is None:
        custom_args.ckpt_path = "/home/clover/Rofunc/examples/learning_rl/OmniIsaacGym_RofuncRL/runs/RofuncRL_PPOTrainer_AuboCubeOmni_23-11-09_17-31-42-224371/checkpoints/best_ckpt.pth"
...
if __name__ == '__main__':
    ...
    parser.add_argument("--task", type=str, default="AuboCubeOmni")
